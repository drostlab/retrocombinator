...
// rcpp_simulate_without_flags
void rcpp_simulate_without_flags(size_t num_seq, size_t seq_length, std::string point_mutation_model, size_t num_jumps, double timestep, double burst_probability, double burst_mean, size_t max_active_copies, double recomb_mean, std::string file_out, size_t num_out_tags, size_t num_out_init, size_t num_out_seqs, size_t num_out_pair, bool to_randomise, bool to_seed, size_t seed, size_t sequence_numbering, size_t family_numbering);
RcppExport SEXP _rcombinator_rcpp_simulate_without_flags(SEXP num_seqSEXP, SEXP seq_lengthSEXP, SEXP point_mutation_modelSEXP, SEXP num_jumpsSEXP, SEXP timestepSEXP, SEXP burst_probabilitySEXP, SEXP burst_meanSEXP, SEXP max_active_copiesSEXP, SEXP recomb_meanSEXP, SEXP file_outSEXP, SEXP num_out_tagsSEXP, SEXP num_out_initSEXP, SEXP num_out_seqsSEXP, SEXP num_out_pairSEXP, SEXP to_randomiseSEXP, SEXP to_seedSEXP, SEXP seedSEXP, SEXP sequence_numberingSEXP, SEXP family_numberingSEXP) {
BEGIN_RCPP
    ...
    rcpp_simulate_without_flags(num_seq, seq_length, point_mutation_model, num_jumps, timestep, burst_probability, burst_mean, max_active_copies, recomb_mean, file_out, num_out_tags, num_out_init, num_out_seqs, num_out_pair, to_randomise, to_seed, seed, sequence_numbering, family_numbering);
    return R_NilValue;
END_RCPP
}
// rcpp_simulate_with_flags
void rcpp_simulate_with_flags(size_t num_seq, size_t seq_length, std::string point_mutation_model, size_t num_sensitive_posns, double inactive_probability, size_t num_jumps, double timestep, double burst_probability, double burst_mean, size_t max_active_copies, size_t max_total_copies, double recomb_mean, double selection_threshold, double fam_proportion, double fam_percentage, std::string file_out, size_t num_out_tags, size_t num_out_init, size_t num_out_seqs, size_t num_out_pair, bool to_randomise, bool to_seed, size_t seed, size_t sequence_numbering, size_t family_numbering);
RcppExport SEXP _rcombinator_rcpp_simulate_with_flags(SEXP num_seqSEXP, SEXP seq_lengthSEXP, SEXP point_mutation_modelSEXP, SEXP num_sensitive_posnsSEXP, SEXP inactive_probabilitySEXP, SEXP num_jumpsSEXP, SEXP timestepSEXP, SEXP burst_probabilitySEXP, SEXP burst_meanSEXP, SEXP max_active_copiesSEXP, SEXP max_total_copiesSEXP, SEXP recomb_meanSEXP, SEXP selection_thresholdSEXP, SEXP fam_proportionSEXP, SEXP fam_percentageSEXP, SEXP file_outSEXP, SEXP num_out_tagsSEXP, SEXP num_out_initSEXP, SEXP num_out_seqsSEXP, SEXP num_out_pairSEXP, SEXP to_randomiseSEXP, SEXP to_seedSEXP, SEXP seedSEXP, SEXP sequence_numberingSEXP, SEXP family_numberingSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< size_t >::type num_seq(num_seqSEXP);
    Rcpp::traits::input_parameter< size_t >::type seq_length(seq_lengthSEXP);
    ...
    Rcpp::traits::input_parameter< size_t >::type sequence_numbering(sequence_numberingSEXP);
    Rcpp::traits::input_parameter< size_t >::type family_numbering(family_numberingSEXP);
    rcpp_simulate_with_flags(num_seq, seq_length, point_mutation_model, num_sensitive_posns, inactive_probability, num_jumps, timestep, burst_probability, burst_mean, max_active_copies, max_total_copies, recomb_mean, selection_threshold, fam_proportion, fam_percentage, file_out, num_out_tags, num_out_init, num_out_seqs, num_out_pair, to_randomise, to_seed, seed, sequence_numbering, family_numbering);
    return R_NilValue;
END_RCPP
}
// return_zero
double return_zero();
RcppExport SEXP _rcombinator_return_zero() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    rcpp_result_gen = Rcpp::wrap(return_zero());
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_rcombinator_rcpp_simulate_without_flags", (DL_FUNC) &_rcombinator_rcpp_simulate_without_flags, 19},
    {"_rcombinator_rcpp_simulate_with_flags", (DL_FUNC) &_rcombinator_rcpp_simulate_with_flags, 25},
    {"_rcombinator_return_zero", (DL_FUNC) &_rcombinator_return_zero, 0},
    {NULL, NULL, 0}
};
