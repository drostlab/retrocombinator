...
# previousSpeciesId - the unique ID of the species this species emerged from; (-1 if nothing)
...
# sequenceId2 - an ID of a different sequence present at the time
...
```{r, eval = FALSE}
# TODO: plotEvolution(data, "initial")   # Distance to initial sequence
# TODO: plotEvolution(data, "pairwise")  # Pairwise distances between sequences
