...
```{r, eval = FALSE}
summary <- summariseEvolution(data)

print(colnames(summary$summaryAtEveryStep))
# step - timestep in the simulation
# realTime - time since the start of the simulation (in millions of years)
# numSequences - how many sequences are present at that time?
# numFamilies - how many families are present at that time?
# divergence - the min, Q25, median, Q75, and max of the similarity to
#              the initial sequence
# pairwiseDivergence - the min, Q25, median, Q75, and max of the
#                      pairwise divergence of the sequences
# familySizes - the mean and standard deviation of family sizes
