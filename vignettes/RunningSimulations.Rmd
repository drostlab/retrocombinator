...
This can be done in two ways - with and without flags for inactivity.
The functions can be called in the following way:

```{r}
# Calling a simulation without flags
simulate_without_flags(num_seq = 5, seq_length = 20,
                       point_mutation_model = "K80",
                       num_jumps = 50, timestep = 2,
...
```{r}
# Calling a simulation without flags
simulate_with_flags(num_seq = 5, seq_length = 20,
                    point_mutation_model = "K80",
